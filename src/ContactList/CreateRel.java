...
public class CreateRel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int l=CL_Gui.ar.size();
        CL_Gui.ar.get(l-1).name=jTextField1.getText();
        CL_Gui.ar.get(l-1).email=jTextField3.getText();
        CL_Gui.ar.get(l-1).mobile=jTextField2.getText();
        CL_Gui.ar.get(l-1).rbds=jTextField4.getText();
        CL_Gui.ar.get(l-1).rlms=jTextField5.getText();
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
